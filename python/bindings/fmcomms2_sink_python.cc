...
/* BINDTOOL_HEADER_FILE_HASH(5f40d560a9663a2fcaf5751d9790f078)                     */
/***********************************************************************************/
...
void bind_fmcomms2_sink(py::module& m)
{
    ...
    py::class_<fmcomms2_sink, gr::sync_block, gr::block, gr::basic_block,
        ...
        .def_static("make_from",&fmcomms2_sink::make_from,
            py::arg("ctx"),
            py::arg("frequency"),
            py::arg("samplerate"),
            py::arg("bandwidth"),
            ...
            py::arg("filter") = "",
            py::arg("auto_filter") = true,
            D(fmcomms2_sink,make_from)
        )


        .def("set_params",&fmcomms2_sink::set_params,
            py::arg("frequency"),
            py::arg("samplerate"),
            py::arg("bandwidth"),
            py::arg("rf_port_select"),
    ...
    py::class_<fmcomms2_sink_f32c, gr::hier_block2,
        ...
        .def("set_params",&fmcomms2_sink_f32c::set_params,
            py::arg("frequency"),
            py::arg("samplerate"),
            py::arg("bandwidth"),
            py::arg("rf_port_select"),
