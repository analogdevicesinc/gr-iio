...
/* BINDTOOL_HEADER_FILE_HASH(c9b0bb34191cc13131a6463f12071bda)                     */
/***********************************************************************************/
...
void bind_fmcomms2_source(py::module& m)
{
    ...
    py::class_<fmcomms2_source, gr::sync_block, gr::block, gr::basic_block,
        ...
        .def_static("make_from",&fmcomms2_source::make_from,
            py::arg("ctx"),
            py::arg("frequency"),
            py::arg("samplerate"),
            py::arg("bandwidth"),
            ...
            py::arg("filter") = "",
            py::arg("auto_filter") = true,
            D(fmcomms2_source,make_from)
        )


        .def("set_params",&fmcomms2_source::set_params,
            py::arg("frequency"),
            py::arg("samplerate"),
            py::arg("bandwidth"),
            py::arg("quadrature"),
    ...
    py::class_<fmcomms2_source_f32c, gr::hier_block2,
        std::shared_ptr<fmcomms2_source_f32c>>(m, "fmcomms2_source_f32c", D(fmcomms2_source_f32c))
        ...
        .def("set_params",&fmcomms2_source_f32c::set_params,
            py::arg("frequency"),
            py::arg("samplerate"),
            py::arg("bandwidth"),
            py::arg("quadrature"),
